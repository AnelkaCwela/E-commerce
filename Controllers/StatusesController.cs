...
namespace OurShop.Controllers
{
    ...
    public class StatusesController : Controller
    {
      ...
      private readonly IServiceCategory _serviceCategory;
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public async Task<IActionResult> CreateQoutationStatuse(QoutationStatuseModel sizeModel)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public async Task<IActionResult> CreateOderType(OderTypeModel sizeModel)
        {
            if (ModelState.IsValid)
            {
